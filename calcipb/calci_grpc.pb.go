...
func (c *calculatorServiceClient) Prime(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/main.CalculatorService/Prime", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) Average(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_AverageClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[1], "/main.CalculatorService/Average", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) Maxnumber(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_MaxnumberClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[2], "/main.CalculatorService/Maxnumber", opts...)
	if err != nil {
		return nil, err
	}
